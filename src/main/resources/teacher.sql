...
-- 강기원T ~
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('강기원', 'ACADEMY', '학원분필 사용 (흰4, 노4, 빨2, 파2 세팅)', '5개, 쉬는시간 3분간 사용하던 지우개로만 정리(물x)', 'PERSONAL', false, '좌측 topic/개념설명 지우지 않고 우측 문제들만 지우기 (#문항번호 표시)', false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('강승연', 'PERSONAL', '강의 시작 전 파우치 받아서 분필 세팅 (쓰기 편하게)', NULL, 'ACADEMY', true, '칠판 조명 끄기 / 종료 후 개인물품 정리하여 6층 강대실 강승연T에게 파우치 전달 / 강의 종료 후 영상 메일 전송 필수', true);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('강지연', 'ACADEMY', NULL, 'PPT 범위 내로 4개', 'ACADEMY', true, 'PPT 켜기', false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('김재훈', 'ACADEMY', '스크린 기준 가운데 2개 + 스크린 벗어나서 2개', '스크린 기준 가운데 2개 + 스크린 벗어나서 2개', 'ACADEMY', false, '마이크 볼륨 작게(2/3까지만)', false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('김지연', 'ACADEMY', NULL, NULL, 'ACADEMY', false, '기본 세팅', false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('남지현', 'PERSONAL', '6층 교재실 보관', NULL, 'PERSONAL', false, NULL, false);

-- 류동원T ~
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('류동원', 'PERSONAL', '6층 강사대기실 보관 (직접 세팅하심)', NULL, 'PERSONAL', false, '왼쪽 위 시간 적혀 있으면 지우지 말 것', false);

-- 문서연T ~
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('문서연', 'PERSONAL', NULL, '지우개패드 개인용 사용 (강의 전 세팅, 여분 5개 옆책상) / 쉬는시간 및 수업끝 정리는 학원 지우개 사용', 'PERSONAL', true, '수업 후 개인 패드 가방에 넣어드리기', false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('박지윤', 'PERSONAL', '6층 강사대기실 보관', NULL, 'ACADEMY', false, '포인터 세팅', false);
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('배경민', 'PERSONAL', '지우개 옆에 학원분필 노란색 1개만 세팅', NULL, 'PERSONAL', false, NULL, false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('송준혁', 'MIXED', '6층 강사대기실 보관 / 학원 흰4 + 개인분필 색깔별 1개씩 (안하면 9:50까지 세팅, 개인분필통은 교탁 옆 통째로)', '스크린 화면 반 기준 좌측에만 4개', 'ACADEMY', false, '9:50까지 세팅 완료, 개인분필통은 교탁 옆에 두기', false);

-- 심규원T ~
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('심규원', 'ACADEMY', NULL, '물지우개 2개 세팅, 여분 준비', 'PERSONAL', false, NULL, false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('심찬우', 'MIXED', '칠판 중앙부터 우측으로 [지-지-학원(흰4노1파1)-개인4-개인3-지-학원(흰4노1파1)-개인(파1보1노1초1)-개인(주1빨1흰1)-지] 세트 반복', '지우개 5개 + 문학 수업 시 마른 지우개 여분 5개씩 2세트', 'PERSONAL', true, '배치표 준수, 쉬는시간 없음, 영상 자료 촬영 시 조그 조정(줌아웃 후 줌인)', false);

-- 안가람T ~
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('안가람', 'ACADEMY', '학원분필 세팅 (단, 개인분필 사용시 6층 강사대기실 보관됨)', NULL, 'ACADEMY', false, NULL, false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('엄영대', 'MIXED', '학원분필+개인분필(6층 강사대기실 보관, 가져다 놓으면 직접 세팅하심)', '쉬는시간 패브릭 지우개로 정리', 'ACADEMY', true, '포인터 세팅, 문항분석표만 뽑기', false);
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('오택민', 'PERSONAL', '직접 가져와서 세팅하심 (남은 분필 50% 이하시 버리기, 이상은 연강시 사용 또는 보관함)', '쉬는시간에 패브릭 지우개로 지우기', 'ACADEMY', false, '남은 분필 상태에 따른 처리 규정 확인', false);
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('우주설', 'PERSONAL', '6층 강사대기실 보관', NULL, 'ACADEMY', false, NULL, false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('유신', 'PERSONAL', '포인터 세팅', '스크린 안에 5개', 'ACADEMY', false, '주차별 분권 교재, 조그 터치 절대 금지 (쉬는시간 포함)', false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('윤지환', 'MIXED', '선생님께 받아서 중앙에 분필 두기', NULL, 'ACADEMY', false, '조그 판서 위주 촬영 (선생님이 우측 끝에 위치하도록 잡기, 줌아웃 금지)', false);

-- 이승헌T ~
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('이승헌', 'ACADEMY', '같이 오시는 실장님이 세팅하심 (개인분필 보관시 6층 강사대기실)', '연강 시 쉬는시간에 지우기', 'ACADEMY', false, '같이 오시는 실장님이 세팅하심', false);
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('이신혁', 'PERSONAL', '6층 강사대기실 보관', NULL, 'ACADEMY', false, '마이크 소리 조금 줄이기', false);
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('이윤희', 'ACADEMY', '스크린 범위에 가깝게 세팅', '스크린 범위에 가깝게 세팅', 'ACADEMY', false, NULL, false);
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('이종걸', 'MIXED', '학원 분필은 흰색만 2개씩', '쉬는시간에 마른 지우개로 지우기', 'ACADEMY', false, '학원 분필은 흰색만 2개씩 (현재 개인마이크 고장으로 임시 학원마이크 세팅)', false);
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('이종길', 'ACADEMY', '기본 세팅 (본인이 필요하면 직접 더 꺼내 쓰심)', NULL, 'ACADEMY', false, '본인이 필요하면 직접 더 꺼내 쓰심', false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('전현정', 'PERSONAL', '6층 강사대기실 보관', '쉬는시간 칠판 정리 x', 'ACADEMY', false, NULL, false);

-- 정승준T ~
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('정승준', 'PERSONAL', '6층 강사대기실 보관 / 분필 상자 속 종이컵 분필 우선 세팅 (흰2 빨노파 1개씩 지우개 옆)', NULL, 'ACADEMY', false, '종이컵 속 분필 우선 사용', false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('정태혁', 'MIXED', '학원 분필은 흰색만 2개씩 세팅 (개인 분필은 강사 대기실)', '지우개-분필 4세트 모두 피피티 안쪽으로 들어오도록 세팅', 'ACADEMY', true, NULL, false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('조은정', 'PERSONAL', '6층 강사대기실 보관 / 칠판 중앙에 핑크,주황,노랑,초록 2개씩 총 8개 세팅(보라X). 색별 1개는 케이스 장착', '패브릭 여분 5개 교탁 옆 세팅', 'ACADEMY', false, '분필 8개(보라 제외), 색별 하나는 케이스 장착', false);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('최정은', 'PERSONAL', '6층 강사대기실 보관', '칠판 중앙부터 우측으로 4개', 'ACADEMY', true, '마이크 확인 필요', false);
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('최지욱', 'PERSONAL', '강사님 공구박스에서 분필만 꺼내서 세팅 / 분필머리가 왼쪽으로 오도록 [흰 빨 주 노 초 파 보] 일렬 3세트 (왼쪽/중앙/오른쪽) / 다음교시 위해 케이스 닦기', '지우개 6개 + 패브릭 6개 여분, [지우개-분필-지우개] 순서로 3세트', 'PERSONAL', false, '에어컨 18도 최대바람 / 학생 교재 한세트 세팅 / 왼쪽 공지사항 확인(있으면 지우지 말 것)', false);
...
-- 한세빈T ~
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('한세빈', 'PERSONAL', '6층 강사대기실 보관', '지우개 ppt 근처로 세팅', 'ACADEMY', true, '교탁에 포인터 세팅, 시험 타이머 직접 켜심, 강의영상+시험분석 메일 전송', true);
...
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('홍준석', 'PERSONAL', '6층 교재실 보관', '쉬는시간에 패브릭으로 칠판 지우기', 'PERSONAL', false, NULL, false);
...
-- 기타 (송지광T, 손정민T)
INSERT INTO teacher (name, chalk_type, chalk_detail, eraser_detail, mic_type, has_ppt, notes, has_email) VALUES ('송지광', 'PERSONAL', '선생님 오시면 분필 받아서 세팅하기', NULL, 'PERSONAL', false, NULL, false);
